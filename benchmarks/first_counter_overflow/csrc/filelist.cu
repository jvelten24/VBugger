...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _1671_archive_1.so
_1671_archive_1.so : archive.355/_1671_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -o .//../simv.daidir//_1671_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_1671_archive_1.so $@


ARCHIVE_OBJS += _prev_archive_1.so
_prev_archive_1.so : archive.355/_prev_archive_1.a
	@$(AR) -s $<
